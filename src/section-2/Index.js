  ...
  return (
    ...
    >
        ...
        <div className="row">
          <div className="col-lg-8 medal text-center container">
            ...
            <p className="logo-para-1">
              MY-IT Web Developer Course is a 100% live classroom and online
              program developed to learn job ready programming skills from
              industry experts. This master developer course in pondy to make
              you proficient in back-end and front-end web technologies.
            </p>
            <div className="btn-type">
              <button
                className="btn btn-primary enquire"
                onClick={popuphandleShow}
              >
                Enquire Now
              </button>
              &nbsp;
      ...
      <div className="container-3 py-lg-5 py-3">
        <div className="container ">
          <div className="row" data-aos="fade-up" data-aos-duration="1900">
            ...
            <div className="col-lg-4 text-center">
              <button className="btn" onClick={popuphandleShow}>
                Join Now!
              </button>
            </div>
          </div>
      ...
      <div data-aos="fade-up" data-aos-duration="1900">
        ...
        <p className=" para-4 pb-3 text-center">
          Enroll Now & Learn Web Developer Code in Just 3 Months with Classroom
          or Online Live Training Program.
        </p>
            ...
            <div class="col-lg-6">
              <div class="card">
                <div class="card-body">
                  ...
                  <p class="card-text">
                    Web Developer Online Training offers live instructor-led
                    classes with intructors who train you in-demands front-end
                    and back-end development skills and Practice with capstone
                    projects.
                  </p>
                  <button
                    class="btn btn-primary mt-2"
