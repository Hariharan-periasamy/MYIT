...
const Footer = () => {
  ...
  return (
    <div className="footer" id="contact">
      <footer className="bg-light text-center text-lg-start pt-4">
=======
...
<<<<<<< HEAD
            ...
            <div className="col-lg-4 col-md-12 mb-4 mb-md-0 text-center">
              ...
              <a href="https://legendstechsolution.com/" target="_blank" rel="noreferrer"><img src="images/legends.png" alt="Logo" className="img-fluid" /></a>
=======
                  <li class="icon youtube">
                    <span class="tooltip">Youtube</span>
